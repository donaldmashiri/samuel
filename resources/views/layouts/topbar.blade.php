    ...
    <ul style="background-color: black" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
            <div class="sidebar-brand-icon">
                <img src="{{ asset('img/minerals.jpeg') }}" class="rounded" width="50" height="50" alt="">
            </div>
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle"
                                 src="{{ asset('img/minerals.jpeg') }}" width="50" height="50">
                        </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                          <span>Copyright © Your Website 2023 developed by Samuel</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
